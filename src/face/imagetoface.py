...
class ImageToFace:
    def __init__(self):
        pass
    def detect_face_in_frame(detector, frame):
    ...
    def imageToEncoding(detector, r, picture):
        
        face = ImageToFace.detect_face_in_frame(detector, picture)
        if face is None:
            return None, None
        
        encoding, face_pixels = ImageToFace.get_face_image_encoding(r, face, picture)
